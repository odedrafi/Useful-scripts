...
aws s3 cp s3://$env:BUCKET_ALGO_NAME/algorithm/$env:ALGORITHM_NAME/bin $Local_algo_bin_path --recursive
...
aws s3 cp s3://$env:BUCKET_ALGO_NAME/algorithm/$env:ALGORITHM_NAME/program-data $Local_progdata_path --recursive
